...
<body class="page-header-fixed page-full-width">
						...
						<div class="container">
							<div class="row-fluid"  style="margin-top: 20px;">	
								...
								<div class="pct_contentRight">
									<h3 class="pct_contentTitle">我的审核记录</h3>
									<div class="pct_expertYueContent" id="checkRecord" >
	...
	<script src="PC/newIndexjs/newCheckRecord.js"></script>
 	<script>
 	 	//添加边框
 		var currentNav = $(".nav_gr");
		var sildeBar = $(".pct_checkRecord");
