...
<body class="page-header-fixed page-full-width">
						...
						<!--导航下内容部分  begin-->
  						<div class="container">
  							<div class="row-fluid" style="margin: 40px 0">		
								...
								<div class="db_contentRight">
									<div class="exp_expertContent">
		  							<span class="index_modelTitle ol_ClassTitle borderTopRadius">在线点播</span>
									<div class="expSearchBar">
										<span id="db_fenleiChange" class="fenlei_title hasPointer" style="color:#0D638F">按分类查找  &gt;</span>
										<span id="fenlei_change" class="fenlei_title"></span>
									  	<input type="text" class="expSearchInput" id="expSearchInput" placeholder="请输入课程名称">
									...
									<div class="db_ClassContainer borderBotRadius"></div>
	...
	<script src="PC/newIndexjs/newDbClass.js"></script>
	<script>
		var currentNav = $(".nav_videoClass");
