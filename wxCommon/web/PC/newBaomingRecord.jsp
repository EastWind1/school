...
<body class="page-header-fixed page-full-width">
						...
						<div class="container">
							<div class="row-fluid" style="margin-top: 20px;">					
								...
								<div class="pct_contentRight">
									<h3 class="pct_contentTitle">我报名的课程</h3>
									<div class="pct_baomingContent"></div>
								</div>
							</div>
	...
	<div id="responsive" class="modal hide fade" tabindex="-1" data-width="760">
 	...
 	<!-- 内容主体  end -->
	<script src="PC/js/page.js"></script>
 	<script src="PC/newIndexjs/newBaomingRecord.js"></script>
 	<script>
 	 	//添加边框
 		var currentNav = $(".nav_gr");
		var sildeBar = $(".pct_baomingJL");
