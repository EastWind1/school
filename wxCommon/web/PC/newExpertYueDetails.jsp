...
<body class="page-header-fixed page-full-width">
						...
						<div class="container">
							<div class="row-fluid"  style="margin-top: 20px;">	
								...
								<div class="pct_contentRight">
									<h3 class="pct_contentTitle">专家预约记录详情</h3>
									<div class="pct_expertYueContent" id="expertOrder" >
									<div style="padding:10px 0;font-size:16px;">选择专家</div>
								...
								<div style="width:100%;padding:10px 0;font-size:16px;color:#222;">
							    	<span style="padding:10px 0 10px;display:inline-block;">病人信息</span>
					            ...
					            <div class="control-group zscontent">
								...
								<div class="control-group zjhlgroupcon">
					                ...
					                <div class="controls">
					                	<textarea id="sum_jiwangshi" class="span10 m-wrap" rows="5" placeholder="既往史描述" style="resize: none;"></textarea>
					                </div>
					            </div> 
								<div class="control-group zjhlgroupcon">
					                <label class="control-label">个人史：</label>
					                <div class="controls">
					                	<textarea id="sum_gerenshi" class="span10 m-wrap" rows="5" placeholder="个人史描述" style="resize: none;"></textarea>
					                </div>
					            </div> 
								<div class="control-group zjhlgroupcon">
								...
								<div class="control-group zjhlgroupcon">
					             ...
					             <div class="control-group lastcontent">
					            ...
					            <div class="control-group lastcontent" id="sysjc">
					                <div style="width:82%;margin-bottom:5px;overflow:hidden;">
					                	<label class="control-label">实验室检查：</label>
					                </div>
					                <div class="controls">
					                	<textarea id="sum_sysjc" class="span10 m-wrap" rows="4" placeholder="实验室检查描述" style="display:inline-block;resize: none;"></textarea>
					            ...
					            <div class="control-group lastcontent">
					                ...
					                <div class="controls">
					                	<textarea id="sum_yxxjc" class="span10 m-wrap" rows="4" placeholder="影像检查描述" style="display:inline-block;resize: none;"></textarea>
					            ...
					            <div class="control-group lastcontent">
					                ...
					                <div class="controls">
					                	<textarea id="sum_other" class="span10 m-wrap" rows="4" placeholder="辅助检查描述" style="display:inline-block;resize: none;"></textarea>
					           ...
					           <div class="control-group">
					            	<a id="summary" class="exp_summaryBtn">提交</a>
					           </div>			
									</div>
								</div>
							</div>
	...
	<script src="PC/newIndexjs/newExpertYueDetails.js"></script>
	</body>
</html>