...
<div class="tab-content contents"> 
	<h3 class="form-section">项目工时统计</h3>
	<div class="row-fluid">
		<div class="span12">
		...
		<table class="table table-striped tableshort" id="listtable">
	           <thead>
	               <tr>
	                   ...
	                   <th style="width:30%;">总工时</th>
	                   <th style="width:30%;">查看人员工时</th>
	               </tr>
	           </thead>
				<tbody id="qkList">
				<tr>
...
var sel=$.Params.create();
	   	sel.ajax(getIP()+"time.action?projecttj",function(data){
	   		if(data.success){
	   		var html;
	   			$.each(data.rows,function(i,val){
	   				...
	   				if(times == null){
						...
						html+="<tr>" +
								"<td>"+val.name+"</td>" +
								"<td>"+parseFloat(times).toFixed(1)+"</td>"+
								"<td onclick='selmember(\""+val.id+"\")'>查看人员工时</td>"+
								"</tr>";
					})
	   	...
	   	function selmember(id){
	   		window.location.href="media/project/tjpMember.jsp?pid="+id;
	   	}
</script>
</html>