...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/project/js/timeList.js"></script>
 	
 </head>

<body class="page-header-fixed" >
<div class="tab-content contents"> 
	<h3 class="form-section">日常工时管理</h3>
	<div class="row-fluid">
		<div class="span12">
	...
	<div class="modal-body">
		<div class="row-fluid">
			<div class="span6">
				...
				<p>
					<select id="roleId">
						<option val="0">请选择项目</option>
					</select>
				</p>
				</div>
				<div class="span6">
				<h4>工时：(工时的范围是0~1)</h4>
				<p><input id="time" type="text" class="span12 m-wrap"></p>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span6">
