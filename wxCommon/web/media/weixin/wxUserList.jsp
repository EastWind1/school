...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/weixin/js/wxUserList.js"></script>
 </head>

<body class="page-header-fixed" >
<div class="tab-content contents"> 
	<h3 class="form-section">微信粉丝管理</h3>
	<div class="row-fluid">
		<div class="span12">
		...
		<table class="table table-striped tableshort" id="listtable">
	           <thead>
	               <tr>
	                   ...
	                   <th style="width:20px;">微信头像</th>
	                   <th style="width:20px;">昵称</th>
	                   <th style="width:10px;">性别</th>
	                   <th style="width:20px;">所在城市</th>
	                   <th style="width:20px;">关注时间</th>
	               </tr>
	           </thead>
				<tbody id="qkList">
				<tr>
