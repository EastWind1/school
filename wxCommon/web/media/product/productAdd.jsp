...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/product/js/productAdd.js"></script>
 	<style>
 		li{ list-style: none;}
 		.courseDbDetails{
 			width: 100%;
	 ...
	 <div class="portlet-body list mbModify">
		<form class="form-horizontal m-t" id="form" novalidate="novalidate">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                	<input id="color"  name="color" minlength="2" type="text" class="form-control" required="" aria-required="true">
                </div>
            </div>
           <div class="control-group">
            ...
            <div class="form-actions">
				<button id="save" type="button" class="btn blue">保存</button>
			</div>
         </form>
