...
ul.page-sidebar-menu > li:last-child > ul.sub-menu{ margin-bottom:60px;}
</style>
	...
	<!-- 左侧菜单开始 -->
		<div class="page-sidebar nav-collapse collapse">
			<ul class="page-sidebar-menu" id="leftmenuclick">
				...
				<li class="open">
					<a><i><img src="media/images/menu1.png"></i> 
						<span class="title">课程管理</span><span class="selected"></span>
					</a>
					<ul class="sub-menu">
				...
				<li class="open">
					...
					<ul class="sub-menu">						
						...
						<li><a class="ajaxify" target="right" href="media/information/PlatformList.jsp">平台简介 </a></li>
					</ul>
				</li>
				<li class="open">
					<a><i><img src="media/images/menu1.png"></i> 
