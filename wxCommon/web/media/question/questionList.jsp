...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/question/js/questionList.js"></script>
 </head>
<body class="page-header-fixed" >
<div class="tab-content contents"> 
	<h3 class="form-section">答案管理</h3>
	<div class="row-fluid">
		<div class="span12">
	     ...
	     <div class="btn-group pull-right listsearch">
	        <button id="removebutton" class="btn blue form_button short">清空</button>
