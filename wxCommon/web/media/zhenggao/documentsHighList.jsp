...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/zhenggao/js/documentsHighList.js"></script>
 </head>
<body class="page-header-fixed" >
<div class="tab-content contents"> 
	<h3 class="form-section">精品管理</h3>
	 <div id="count" style="text-align:center;font-size:18px;"></div>
	<div class="row-fluid">
		<div class="span12">
	 ...
	 <div class="portlet-body list">
		<table class="table table-striped tableshort" id="listtable">
	           <thead>
				   <tr>
	                   <th style="width:6%;"><div class="checker" id="uniform-queryCheckbox"><span><input type="checkbox" id="queryCheckbox" name="queryCheckbox" value=""></span></div></th>
	                   <th style="width:10%;">头像</th>
	                   <th style="width:10%;">姓名</th>
	                   <th style="width:14%;">所在医院</th>   
	                   <th style="width:25%;">微小说</th>     
	                   <th style="width:10%;">投稿时间</th>
	                   <th style="width:10%;">当前票数</th>
