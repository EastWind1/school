...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/event_fz/js/groupModify.js"></script>
 	<style>
 		li{ list-style: none;}
 		.courseDbDetails{
 			width: 100%;
	 ...
	 <div class="portlet-body list mbModify">
		<form class="form-horizontal m-t" id="commentForm" novalidate="novalidate">
             ...
             <div class="control-group">
                ...
                <div class="controls">
                    <input id="group" name="group" minlength="2" type="text" class="form-control" required="" aria-required="true">
                </div>
            </div>
