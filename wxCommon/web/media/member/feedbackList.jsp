...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/member/js/feedbackList.js"></script>
 </head>

<body class="page-header-fixed" >
<div class="tab-content contents"> 
	<h3 class="form-section">联系我们反馈记录</h3>
	...
	<div class="row-fluid">
	 ...
	 <div class="portlet-body list">
		<table class="table table-striped tableshort" id="listtable">
	           <thead>
	               <tr>
	                   <th style="width:20%;"><input type="checkbox"  id="queryCheckbox"  name="queryCheckbox" value=""></th>
	                   <th style="width:20%;">会员姓名</th>
