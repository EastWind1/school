...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/member/js/memberExpList.js"></script>
 	<style type="text/css">
...
<div class="tab-content contents"> 
	<h3 class="form-section">专家会员账号管理</h3>
	<div class="row-fluid">
		<div class="span12">
	     ...
	     <!--   <button id="rzbutton" class="btn blue form_button short">专家认证</button>  -->
		</div>
