...
var chinacity=china.length;
    ...
    $("#addbutton").on("click",function(){
    	window.location.href="media/member/memberSpecialUserAdd.jsp?type=5";
    })
...
function update(id){
	window.location.href="media/member/memberSpecialUserModify.jsp?eid="+id+"&type=5";
}
