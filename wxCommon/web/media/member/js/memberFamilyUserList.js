...
$(function(){
    ...
    $("#addbutton").on("click",function(){
    	window.location.href="media/member/memberHighUserAdd.jsp?type="+7;
    })
    
     $("#addMemberbutton").on("click",function(){
    	window.location.href="media/member/memberGetMeetAdd.jsp?type="+7;
    })
...
function update(id){
	window.location.href="media/member/memberHighUserModify.jsp?eid="+id+"&type="+7;
}
