				...
				if(len >0){
					$.each(data.rows,function(i,val){
						html+="<tr>" +
								...
								"<td>"+val.tel+"</td>" +
								"<td>"+val.email+"</td>"+
								"<td style='cursor:pointer' onclick='update(\""+val.id+"\",\""+val.loginName+"\",\""+val.userName+"\",\""+val.tel+"\",\""+val.email+"\",\""+val.roleId+"\")'>"+
								"<span class='checkDetailsBtn' style='width:60%'>修改</span></td></tr>";
					})
				}else{
