...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/conferencePay/js/conferencePayList.js"></script>
 </head>
<body class="page-header-fixed" >
<div class="tab-content contents"> 
	<h3 class="form-section">会议缴费管理</h3>
	<div class="row-fluid">
		<div class="span12">
		...
		<table class="table table-striped tableshort" id="listtable">
	           <thead>
				   <tr>
	                   ...
	                   <th style="width:10%;">医生缴费价格</th>
	                   <th style="width:10%;">护士缴费价格</th>
	                   <th style="width:10%;">学生缴费价格</th>
