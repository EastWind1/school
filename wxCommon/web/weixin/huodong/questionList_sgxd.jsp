...
<html>
  <head>
	...
	<style type="text/css">
		...
		/*主体*/
		.content{ background: url(../images/sgxd.png) left top no-repeat; background-size: 100%;}
		.qesList{ margin: 0 11%;}
  	...
  	<body>
	    <div class="content qesMain">
				<div class="card qesHead">
					...
					<div style="padding: 10px 5% 0; float: left; line-height: 30px;overflow: hidden;">
						<p style="float: left;padding-top: 6%;"></p>
					</div>
					<div style="margin-right: 5%; float: right; overflow: hidden;">
						<!-- <img src="../images/tp.png"/> -->
					</div>
				</div>
				<div class="card qesList" style="overflow: scroll;height: 540px;">
				<p style="padding-left: 24px;border-bottom: 1px solid #000;font-size: 24px;padding-bottom: 15px;color: #000;" id="questionTitle" ></p>
						 ...
						 if(headimg == "" || headimg == null){
						    ...
						    html+="<li class='table-view-cell media'>"+
					      		  "<img class='media-object pull-left' src='"+headimg+"'>"+
					      			"<div class='media-body qesNickname'><span>"+val.nickName+
					      			"</span><p class='qesConten'>"+val.question+"</p></li>"; 	
						}
						})
