...
<html>
  <head>
	...
	<style type="text/css">
		...
		/*主体*/
		.content{ background: url(../images/beijing.png) left top no-repeat; background-size: cover;}
		.qesList{ margin: 0 11%;}
	    ...
	    <div class="content qesMain">
				<div class="card qesHead">
					...
					<div style="padding: 10px 5% 0; float: left; line-height: 30px;overflow: hidden;">
						<img src="../images/shoujie.png" style="float: left;width: 100px;height: 100px;"/>
						<p style="float: left;padding-top: 6%;">中国重症医学信息化与互联网大会</p>
					</div>
					<div style="margin-right: 5%; float: right; overflow: hidden;">
						<img src="../images/ICU_logo.png"/>
					</div>
				</div>
