...
var state="";
    $(function () {
        ...
        var totalDeg = 360;
        var steps = [];
        //306：一等奖 378：二等奖  342：参与奖   270:不要灰心 234：三等奖  198:继续努力 162：四等奖 126:参与奖  90：五等奖  54：要加油哦
        //306：一等奖 378：二等奖  342：参与奖   270:不要灰心 234：三等奖  198:继续努力 162：四等奖  126:参与奖  90：五等奖  54：要加油哦
        var lostDeg = [];//不中奖的角度
        var prizeDeg = [342, 234, 162,126, 90,270,198,54,306,378];//中奖的角度 
            ...
            if (now < steps.length) {
                ...
                if (prize != null) {
                   ...
                   $("#sncode").text(sncode);
                    ...
                    if (prize == 1) {
                        type = "三等奖";
                        prizesName="车款抵用券300元";
                    } else if (prize == 2) {
                        type = "四等奖";
                        prizesName="售后养护代金券50元";
                    }else if (prize == 4) {
                        type = "五等奖";
                        prizesName="精美盒抽";
                    }
		...
		$.each(data.row,function(i,val){
			var customerName=val.nick_name;
