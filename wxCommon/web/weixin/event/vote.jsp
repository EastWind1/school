	...
	<script>
		...
		$(function(){
			...
			$("#tp_subBtn").on("click",function(){
				...
				$("li[selected]").each(function(){
					...
					var param="{\"id\":\""+id+"\",\"eventId\":\""+eventId+"\",\"memberId\":\""+openId+"\",\"createTime\":\""+createTime+"\"}";
					params.push(param);
				});
				var params1="["+params+"]";
		    	...
		    	add.ajax(getIP()+"eventvote.action?addMoreVote",function(data){
		    		if(data.success){
		    			...
		    			window.location.href="weixin/game/shake/shake.jsp";
		    		}else{
		    			alert(data.msg);
		    			return;
		    		}
    	...
    	function sendTicket(obj){
    		...
    		if(isgz == 1){
    			...
    			window.location.href="http://mp.weixin.qq.com/s?__biz=MzAxODU0MzM0MA==&mid=401983948&idx=1&sn=f4e3534e8af9545354b725cbd16705e1#rd";
    		}
