	...
	<div id="scroller">
		<div class="card formgroup chec">
			...
			<li class="table-view-cell allorderitle">
			 ...
			 <li class="table-view-cell orderinput newor">
			 	<div class="input-row"><label>主诉(<font color="#FF0101">必填</font>)：</label></div>
			 </li>
			 ...
			 <li class="table-view-cell orderinput newor">
			 	<div class="input-row"><label>病情描述：</label></div>
			 </li>
			 <li class="table-view-cell orderinput newor tex">
 		...
 		<div class="content-padded">
	      <a class="btn btn-primary btn-block" id="reg">更新</a>
	    </div> 
 	</div>
 	</div>
 	</div>
...
<!--  <div id="uporderImg" class="modeldigo" style="display: none">
  ...
  <script type="text/javascript" src="weixin/order/js/orderDetailDoctor.js"> </script>
</html>
