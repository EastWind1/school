$(function(){
	    	...
	    	$.each(data.rows,function(i,val){
	    		...
	    		/*html+="<div class='card zxobj' onclick='getExpert(\""+val.pkid+"\",\""+val.field4+"\")'><ul class='table-view zxul'><li class='table-view-cell'>"+
	 			...
	 			html+="<li style='padding:5px;' class='table-view-cell media' onclick='getExpert(\""+val.pkid+"\",\""+val.field4+"\")'>" +
	 					...
	 					"<img style='width:100px;height:100px; margin:0 auto;' class='media-object pull-left' src=data/material/"+val.informationImage+" >" +
	 					val.informationTitle+"</a><p>"+val.createTime+"</p></li>"
	...
	function getExpert(eid,filed){
		window.location.href="weixin/app/informationDetails.jsp?eid="+eid;
//		if(filed != "0"){
