 		...
 		<script>
 			$(function(){
				...
				$("#submit").on("click", function() {
					$.ajax({
						url:"server.action?updMoreByPkId",
			   	 		data:{"id":<%=serviceid%>,"name":$('#name').val(),"description":$("#description").val(),"price":$("#price").val(),"kind":$("#classId").val()},
			   	 		type: "get",
			   	 		dataType: "JSON",
			   	 		success: function(data){
			   	 			$("#name").val(data.rows.name);
	    ...
	    <div class="g-flexview">
	        <header class="m-navbar my-header">
	            ...
	            <div class="navbar-center">
	                <span class="navbar-title">修改服务</span>
	            </div>
	        </header>
	        <div class="eva-main g-scrollview">
	            ...
	            <div class="eva-text clearfix">
	                <div class="m-celltitle">服务简介</div>
	                <div class="m-cell">
	                    <div class="cell-item">
	                        <div class="cell-right">
	                            <textarea id="description" class="cell-textarea" placeholder="输入你的服务简介" maxlength="500"></textarea>
	                        </div>
	                    </div>
	                </div>
	            </div>
	            ...
	            <div class="eva-text clearfix">
	                <div class="m-celltitle">服务参考报酬</div>
	                <div class="m-cell">
	                    <div class="cell-item">
	            ...
	            <div class="eva-list">
	                <div class="orl-list clearfix">
	                    <a id="submit" class="btn-block btn-primary">提交更改</a>
	                </div>
	            </div>
	        </div>      
	    </div>
