...
import com.ian.media.util.WxService;
import com.ian.media.util.MyX509TrustManager;
...
public class WxPublicUtil {
	 ...
	 * 获取ticket
	 */
	public static String getTicket(String publicNo){
		String url=WxInterface.get_ticket;
	...
	public static Map<Object, Object> getTokenByUrl(String appId,String appSecret,String publicNo){
        ...
        if (jsonObject != null) {
        	...
        	WxPublic wxPublic=new WxPublic();
        	wxPublic.setPublicNo(publicNo);
        	wxPublic.setAccessToken(accessToken);
        	wxPublic.setTokenTime(Time.nowDateToString());
        	wxPublicDao.updateByPrimaryKeySelective(wxPublic);
        	map.put("accessToken", accessToken);
        	map.put("success",true);
        }else {
	...
	public static void setWxPublicDao(WxPublicMapper wxPublicDao) {
		WxPublicUtil.wxPublicDao = wxPublicDao;
	}
	...
	public static void setWxUserDao(WxUsersMapper wxUserDao) {
		WxPublicUtil.wxUserDao = wxUserDao;
	}
	
	 public static void main(String[] args) throws JSONException {
		 WxPublicUtil.getTicket("gh_8d5f9c073de7");
	 }
	...
	public static void setQrCodeInfoDao(QRCodeInfoMapper qrCodeInfoDao) {
		WxPublicUtil.qrCodeInfoDao = qrCodeInfoDao;
	}
