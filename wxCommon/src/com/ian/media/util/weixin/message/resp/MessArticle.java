...
public class MessArticle {
	...
	private String content;//	是	图文消息页面的内容，支持HTML标签。具备微信支付权限的公众号，可以使用a标签，其他公众号不能使用，如需插入小程序卡片，可参考下文。
	private String digest;//	否	图文消息的描述，如本字段为空，则默认抓取正文前64个字
