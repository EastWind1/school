     ...
     public String ueditor(HttpServletRequest request,HttpServletResponse response,String action) {
         ...
         if("config".equals(action)){
             ...
             try{
                 ...
                 // 定义图片路径
                 String path = request.getSession().getServletContext().getRealPath(
                         File.separator+"data"+File.separator+"material"+File.separator+"ueditor"+File.separator)+File.separator;
                 ...
                 for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
                     ...
                     String imageName = "material"+"_"+imgDate+".jpg";
                     ...
                     map.put("url","data/material/ueditor/"+imgName);
